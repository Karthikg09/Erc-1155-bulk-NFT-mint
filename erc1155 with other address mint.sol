...
contract ArtCollectible is Ownable, ERC1155 {
    ...
    function mintTo(address _to, uint256 _id, uint256 _amount) public onlyOwner {
      _mint(_to, _id, _amount, '');
    }

    function mintBatchTo(address _to, uint256[] memory _ids, uint256[] memory _amounts) public onlyOwner {
